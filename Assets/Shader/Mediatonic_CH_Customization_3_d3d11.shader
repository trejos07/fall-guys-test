...
//
///////////////////////////////////////////
Shader "Mediatonic/CH_Customization_3" {
Properties {
[Header(Skin Pattern)] [Space(10)] _SkinPattern ("Skin Pattern", 2D) = "white" { }
[Header(Skin Albedo)] [Space(10)] _AColor ("Color A", Color) = (1,1,1,1)
_BColor ("Color B", Color) = (1,1,1,1)
_EyesColor ("Color Eyes", Color) = (1,1,1,1)
_FaceColor ("Color Face", Color) = (1,1,1,1)
_HDRFix ("HDR Fix", Float) = 1.6
[Space(10)] _FaceMap ("Face Map", 2D) = "white" { }
[Header(Skin Smoothness Metallic)] [Space(10)] _AGlossiness ("Smoothness A", Range(0, 1)) = 0.5
_AMetallic ("Metallic A", Range(0, 1)) = 0.5
_BGlossiness ("Smoothness B", Range(0, 1)) = 0.5
_BMetallic ("Metallic B", Range(0, 1)) = 0.5
[Header(Normal Map)] [Space(10)] _NormalMap ("Normal Map", 2D) = "bump" { }
_BodyMask ("Body Mask", 2D) = "white" { }
[Header(Costume)] [Space(10)] _CostumeMaskTop ("Costume Mask Top", 2D) = "white" { }
_CostumeMaskBottom ("Costume Mask Bottom", 2D) = "white" { }
[Header(Rim)] [Space(10)] _RimColor ("Rim Color", Color) = (0.26,0.19,0.16,0)
