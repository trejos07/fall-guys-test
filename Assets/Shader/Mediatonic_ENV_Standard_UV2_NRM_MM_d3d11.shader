...
//
///////////////////////////////////////////
Shader "Mediatonic/ENV_Standard_UV2_NRM_MM" {
Properties {
[Header(Albedo)] [Space(10)] _MainTex ("Albedo (UV01)", 2D) = "white" { }
_Color ("Tint", Color) = (1,1,1,1)
_MainTex2 ("Albedo2 (UV01)", 2D) = "white" { }
[Header(Metallic Smoothness)] [Space(10)] _MetallicRoughness ("Metallic (R) Smoothness (G) (UV02) ", 2D) = "white" { }
_RoughnessRange ("Smoothness Range", Range(0, 3)) = 1
[Header(NormalMap)] [Space(10)] _NormalMap ("Normal Map  (UV02)", 2D) = "bump" { }
