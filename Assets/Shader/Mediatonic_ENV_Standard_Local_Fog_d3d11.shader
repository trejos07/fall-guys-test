...
//
///////////////////////////////////////////
Shader "Mediatonic/ENV_Standard_Local_Fog" {
Properties {
...
_RoughnessRange ("Roughness Range", Range(0, 3)) = 1
[Header(NormalMap)] [Space(10)] _NormalMap ("Normal Map", 2D) = "bump" { }
_NormalBoost ("Normal Power", Range(0, 20)) = 0
[Header(Rim)] [Space(10)] _RimColor ("Rim Color", Color) = (0.26,0.19,0.16,1)
_RimPower ("Rim Power", Range(0.5, 8)) = 3
[Header(Gradient)] [Space(10)] _FogStartY ("Gradient Contrast", Float) = 0
_FogEndY ("Gradient Offset", Float) = 0
_FakeFog ("Gradient Color", Color) = (1,1,1,1)
}
SubShader {
