...
//
///////////////////////////////////////////
Shader "Mediatonic/CH_Costume_Emissive" {
Properties {
[Header(Albedo)] [Space(10)] _MainTex ("Albedo (RGB) Team Mask (A) ", 2D) = "white" { }
[PerRenderData] _TeamColor ("Team Color", Color) = (1,1,1,1)
[Header(Metallic Roughness)] [Space(10)] _MetallicRoughness ("Metallic (R) Roughness (G) Emissive Mask (B)", 2D) = "white" { }
_RoughnessRange ("Roughness Range", Range(0, 1)) = 1
[Header(NormalMap)] [Space(10)] _NormalMap ("Normal Map", 2D) = "bump" { }
[Header(Rim)] [Space(10)] _RimColor ("Rim Color", Color) = (0.26,0.19,0.16,1)
_RimPower ("Rim Power", Range(0.5, 8)) = 3
[Header(Emissive)] [Space(10)] _EmissionMin ("Emissive Min", Float) = 1
_EmissionMax ("Emissive Max", Float) = 1
_EmissiveColor ("Emissive Color", Color) = (0.26,0.19,0.16,1)
