...
//
///////////////////////////////////////////
Shader "Mediatonic/ENV_Standard_Emissive" {
Properties {
[Header(Albedo)] [Space(10)] _MainTex ("Albedo (UV01)", 2D) = "white" { }
[PerRenderData] _Color ("Tint", Color) = (1,1,1,1)
[Header(Metallic Smoothness Emissive)] [Space(10)] _MetallicRoughness ("Metallic (R) Smoothness (G) Emissive (B) (UV01)", 2D) = "white" { }
_RoughnessRange ("Smoothness Range", Range(0, 3)) = 1
[Header(NormalMap)] [Space(10)] _NormalMap ("Normal Map (UV01)", 2D) = "bump" { }
...
[PerRenderData] _EmissiveColor ("Emissive Color", Color) = (0.26,0.19,0.16,1)
[PerRenderData] _EmissivePower ("Emissive Power", Float) = 3
}
SubShader {
