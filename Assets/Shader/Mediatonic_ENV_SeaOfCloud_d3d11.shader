...
//
///////////////////////////////////////////
Shader "Mediatonic/ENV_SeaOfCloud" {
Properties {
[Header(Albedo)] [Space(10)] _MainTex ("Albedo (UV01)", 2D) = "white" { }
_Color ("Tint", Color) = (1,1,1,1)
_OuterColor ("Outside Edge Color", Color) = (1,1,1,1)
_AlphaTex ("Alpha (UV01)", 2D) = "white" { }
_AlphaPower ("Alpha Power", Float) = 0
_AlphaU ("Alpha U Tile", Float) = 0
_AlphaV ("Alpha U Tile", Float) = 0
_ScrollXSpeed ("X Scroll Speed", Range(0, 1)) = 0.1
_ScrollYSpeed ("Y Scroll Speed", Range(0, 1)) = 0.1
_EffectMask ("Effect Mask", 2D) = "white" { }
_VertexDis ("Vertex Wave", Float) = 0.1
_Frequency ("Wave Frequency", Float) = 10
_Amplitude ("Effect Range", Range(0.1, 2)) = 0.1
_test ("Wave Amplitude", Range(0, 2)) = 0.1
