...
//
///////////////////////////////////////////
Shader "Mediatonic/ENV_Standard_Pattern_Terrain" {
Properties {
[Header(Albedo)] [Space(10)] _MainTex ("Albedo (UV01)", 2D) = "white" { }
_AlbedoU ("Albedo U", Float) = 1
_AlbedoV ("Albedo V", Float) = 1
_MainTex2 ("Albedo2 (UV01)", 2D) = "white" { }
_Albedo2U ("Albedo2 U", Float) = 1
_Albedo2V ("Albedo2 V", Float) = 1
[Space(10)] _Color ("Tint", Color) = (1,1,1,1)
_Color2 ("Tint2", Color) = (1,1,1,1)
[Space(10)] _EdgeColor ("Terrain Edge Color", Color) = (1,1,1,1)
_EdgePower ("Terrain Edge Power", Range(0, 5)) = 1
[Header(Metallic Smoothness)] [Space(10)] _MetallicRoughness ("Metallic (R) Smoothness (G) (UV01)", 2D) = "white" { }
_MetallicRoughnessU ("Metallic Smoothness U", Float) = 1
_MetallicRoughnessV ("Metallic Smoothness V", Float) = 1
[Space(10)] _RoughnessRange ("Smoothness Range", Range(0, 3)) = 1
_RoughnessDetail ("Smoothness Detail (UV01)", 2D) = "gray" { }
[Header(NormalMap)] [Space(10)] _BumpMap ("Normal Map (UV01)", 2D) = "bump" { }
_BumpMapU ("Normal Map U", Float) = 1
_BumpMapV ("Normal Map V", Float) = 1
[Space(10)] _NormalScale ("Normal Strength", Range(0, 20)) = 1
