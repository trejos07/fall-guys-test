...
//
///////////////////////////////////////////
Shader "Mediatonic/ENV_Standard_Pattern_Variant" {
Properties {
[Header(Albedo)] [Space(10)] _MainTex ("Albedo", 2D) = "white" { }
...
_MetallicRoughnessU ("Metallic Roughness U", Float) = 1
_MetallicRoughnessV ("Metallic Roughness V", Float) = 1
[Space(10)] _RoughnessRange ("Roughness Range", Range(0, 3)) = 1
_RoughnessDetail ("Roughness Detail", 2D) = "gray" { }
[Header(NormalMap)] [Space(10)] _BumpMap ("Normal Map", 2D) = "bump" { }
