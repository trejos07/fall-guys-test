...
//
///////////////////////////////////////////
Shader "Mediatonic/GeometricFresnel" {
Properties {
_SkyColor ("Sky Color", Color) = (0,0,1,1)
_HorizonColor ("Horizon Color", Color) = (0.5843138,0.8784314,0.8627452,1)
_Contrast ("Contrast", Float) = 3
_FresnelExponent ("FresnelExponent", Range(0, 200)) = 1
_AnimationSpeed ("Animation Speed", Range(0, 3)) = 0.5
_MainTex ("MainTex", 2D) = "white" { }
_GlowColor ("Glow Color", Color) = (0.8758692,0.8980392,0.06666663,1)
_GlowIntensity ("Glow Intensity", Float) = 0.1
