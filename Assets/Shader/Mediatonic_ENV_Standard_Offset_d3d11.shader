...
//
///////////////////////////////////////////
Shader "Mediatonic/ENV_Standard_Offset" {
Properties {
[Header(Albedo)] [Space(10)] [PerRenderData] _MainTex ("Albedo (UV01)", 2D) = "white" { }
_Color ("Tint", Color) = (1,1,1,1)
[PerRenderData] _AlbedoU ("Albedo U", Float) = 1
[PerRenderData] _AlbedoV ("Albedo V", Float) = 1
[PerRenderData] _OffsetU ("Offset U", Float) = 0
[PerRenderData] _OffsetV ("Offset V", Float) = 0
_AlbedoBoost ("Albedo Burn", Range(0, 20)) = 0
